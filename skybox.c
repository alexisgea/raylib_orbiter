...
static Model InitSkybox(int GLSL_VERSION) {
    ...
    SetShaderValue(skybox.materials[0].shader, GetShaderLocation(skybox.materials[0].shader, "vflipped"), (int[1]){ vflipped ? 1 : 0 }, SHADER_UNIFORM_INT);
    SetShaderValue(skybox.materials[0].shader, GetShaderLocation(skybox.materials[0].shader, "alpha"), (float[1]){ alpha }, SHADER_UNIFORM_FLOAT);
    ...
    {
        // TextCopy(skyboxFileName, "resources/textures/starmap_4k.png");

        // Load HDR panorama (sphere) texture
        panorama = LoadTexture("resources/textures/celestial_grid.png");
        // panorama = LoadTexture("resources/textures/constellation_figures_g.png");
